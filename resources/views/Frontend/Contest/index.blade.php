...
<div class="breadcrumb-container" style="margin-bottom: 24px;">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-white px-0 py-2" style="margin-bottom:0;">
            ...
            <li class="breadcrumb-item active" aria-current="page">Contest MIS</li>
        </ol>
    </nav>
</div>
...
<div class="card">
    <div class="application-header">
        <h3 class="application-heading">Contest MIS Details</h3>
        <div class="btn-container">
            @php($roleId = auth()->user()->roles[0]->id ?? null)
            @if(auth()->user()->hasPermission('upload-mis','create') || auth()->user()->hasPermission('contest','create') || in_array($roleId, [1,35,36]))
            <a href="{{ route('contest.upload.view') }}" style="text-decoration: none;">
                <button class="application-header-btn add-bank-target-res1">
                    <img class="application-header-icon" src="{{ asset('assets/images/import.svg') }}">Upload Contest MIS
                </button>
            </a>
            <a href="{{ route('contest.upload.view') }}" style="text-decoration: none;">
    ...
    <div class="table-responsive p-4" id="dataTable">
        @include('Frontend.Contest.Table.contest_table')
    </div>
</div>
@endsection

@section('script')
@include('Frontend.Contest.index_js')
@endsection
