...
<div class="mb-4 mt-4">
    <div class="row flex align-items-center justify-content-between">
        <div class="col-sm-6">
            <h2 class="upload-file-heading">Upload Contest MIS File</h2>
        </div>
        <div class="col-sm-4">
...
<div>
    ...
    <div class="alert alert-info">
        Required headers: <strong>APPLICATION NO., LOCATION, DISBURSEMENT DATE, CUSTOMER NAME, LOAN AMT, CONTEST RATE, CONTEST AMT</strong>
    </div>

    <form method="POST" action="{{ route('contest.upload') }}" enctype="multipart/form-data">
        @csrf
