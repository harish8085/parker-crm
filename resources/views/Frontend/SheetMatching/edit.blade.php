    ...
    <div class="bank-card">
        ...
        <div class="card-form">
            ...
            <div class="bank-detail-inputs">
                ...
                <input class="bank-detail-input form-control row_input" name="case_state" id="case_state" list="fileCols" value="{{$data->case_state}}" placeholder="Type or choose column name">
            </div>
