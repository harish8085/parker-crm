    ...
    <div class="bank-card">
        ...
        <div class="card-form">
            ...
            <div class="bank-detail-inputs">
                ...
                <input class="bank-detail-input form-control row_input" name="payout_rate" id="payout_rate" list="fileCols" value="{{$data->payout_rate}}" placeholder="Type or choose column name">
            </div>
