...
<div class="card">
    <div class="application-header">
        ...
        <div class="btn-container">
            ...
            @endphp
            @if(!$isRestricted)
            <button class="application-header-btn add-bank-target-res1" data-bs-toggle="modal" data-bs-target="#createBankProduct">
                <img class="application-header-icon" src="{{ asset('assets/images/add-table-icon.svg') }}">Add Product
            </button>
            <button class="application-header-btn add-bank-target-res2" data-bs-toggle="modal" data-bs-target="#createBankProduct">
